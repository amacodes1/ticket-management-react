        ...
        <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <div className="flex flex-col gap-4 rounded-xl bg-gray-50 dark:bg-gray-800/50 p-6 shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <p className="text-lg font-medium text-[#111827] dark:text-white">Total Tickets</p>
            </div>
            <p className="text-4xl font-bold tracking-tight text-[#111827] dark:text-white">{total}</p>
          </div>
          <div className="flex flex-col gap-4 rounded-xl bg-green-50 dark:bg-green-900/20 p-6 shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <p className="text-lg font-medium text-[#111827] dark:text-white">Open Tickets</p>
            </div>
            <p className="text-4xl font-bold tracking-tight text-green-600">{open}</p>
          </div>
          <div className="flex flex-col gap-4 rounded-xl bg-amber-50 dark:bg-amber-900/20 p-6 shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <p className="text-lg font-medium text-[#111827] dark:text-white">In Progress</p>
            </div>
            <p className="text-4xl font-bold tracking-tight text-amber-600">{inProg}</p>
          </div>
          <div className="flex flex-col gap-4 rounded-xl bg-blue-50 dark:bg-blue-900/20 p-6 shadow-sm">
            <div className="flex items-center gap-4">
              ...
              <p className="text-lg font-medium text-[#111827] dark:text-white">Resolved Tickets</p>
            </div>
            <p className="text-4xl font-bold tracking-tight text-blue-600">{closed}</p>
          </div>
        </div>
        <div className="mt-10">
          <Link
